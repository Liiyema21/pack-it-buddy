...
const PromoCode = () => {
  ...
  return (
    <div className="bg-white p-5 rounded-lg shadow-md w-[90%] max-w-[750px] text-center mt-16 ml-[350px]">
      <h1 className="text-2xl mb-5">Apply Promo Code</h1>
      ...
      {yourPromoOffer && (
        <div id="your-promotions" className="mt-8 text-left">
          <div className="text-lg font-medium">Your Promotions</div>
          <div id="your-promo-offer" className="bg-gray-100 p-4 rounded-md mt-2 max-w-[750px]">
...
const DealsAndDiscounts = () => {
  return (
    <main className="p-5 ">
      <PromoCode />
      <div id="current-offers" className="mt-8 ml-[350px]">
        <div className="text-lg font-medium">Current Offers</div>
        <div className="bg-gray-100 p-4 rounded-md mt-2 max-w-[750px]">
